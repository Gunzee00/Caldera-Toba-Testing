...
describe('Uji API Buat Artikel', () => {
  const testCases = [
    {
      description: 'seharusnya membuat artikel dengan data yang valid',
      postData: {
        gambar: 'TisDaSeason.jpg',
        deskripsi: 'Ini saatnya tahun...',
        judul_artikel: 'Feastivus Strikes Back',
      },
    },
    {
      description: 'seharusnya membuat artikel dengan gambar kosong',
      postData: {
        gambar: '',
        deskripsi: 'Ini saatnya tahun...',
        judul_artikel: 'Feastivus Strikes Back',
    ...
    {
      description: 'seharusnya membuat artikel dengan deskripsi kosong',
      postData: {
        gambar: 'gambar',
        deskripsi: '',
        judul_artikel: 'Feastivus Strikes Back',
    ...
    {
      description: 'seharusnya membuat artikel dengan judul_artikel kosong',
      postData: {
        gambar: 'gambar',
    ...
    {
      description: 'seharusnya membuat artikel dengan gambar dan deskripsi kosong',
      postData: {
        gambar: '',
        deskripsi: '',
        judul_artikel: 'Feastivus Strikes Back',
    ...
    {
      description: 'seharusnya membuat artikel dengan semua field kosong',
      postData: {
        gambar: '',
        deskripsi: '',
        judul_artikel: '',
  ...
  testCases.forEach((testCase) => {
    it(testCase.description, async () => {
      try {
        const response = await axios.post('http://localhost:3002/api/createartikel', testCase.postData);
