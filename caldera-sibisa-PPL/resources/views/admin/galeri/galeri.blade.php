            ...
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/detail-galeri/{{ $item['id_galeri'] }}" class="btn btn-primary btn-block btn-sm">Selengkapnya</a>
                        <div class="row my-2">
                            <div class="col">
                                <a href="/edit-galeri/{{ $item['id_galeri'] }}" class="btn btn-primary btn-block btn-sm">Ubah</a>
                            </div>
                            <div class="col">
